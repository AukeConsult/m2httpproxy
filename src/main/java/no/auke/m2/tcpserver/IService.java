...
/**
 * Here is the Service interface that we have seen so much of. It defines only a
 * single method which is invoked to provide the service. serve() will be passed
 * an input stream and an output stream to the client. It should do whatever it
 * wants with them, and should close them before returning.
 * 
